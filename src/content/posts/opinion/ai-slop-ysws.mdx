...
![A Slack message from me asking "When is it moral to submit projects using AI to YSWSes? When is something "too much AI"?"](https://stelle.codes/posts/images/slack-q-toomuchai.png)
![A Slack message from @Rohan saying "I think Ai is fine aslong as it's Claude"](https://stelle.codes/posts/images/aslong-as-its-claude.png)
...
![Screenshot of Hack Club website saying "Welcome to Hack Club / We are 111,620 teen hackers"](https://stelle.codes/posts/images/wth-111k.png)
...
![Me prompting Claude, asking "How can I add a blog to my website? list some ideas"](https://stelle.codes/posts/images/how-blog-website-claude.png)
...
![Section from HCTG submission guidelines detailing 30% AI limit](https://stelle.codes/posts/images/hctg-30-percent.png)
![Message from @NotARoomba detailing a 40% AI limit](https://stelle.codes/posts/images/notaroomba-40-percent.png)
...
![Prox2 anonymous message saying "We should add a VAC ban-like thingy for YSWSes"](https://stelle.codes/posts/images/vac-bans-anon.png)
