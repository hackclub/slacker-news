...
![A Slack message from me asking "When is it moral to submit projects using AI to YSWSes? When is something "too much AI"?"](https://cdn.hackclub.com/019ff3d5-48f0-777d-bce9-cb8fb13d18fe/slack-q-toomuchai.png)
![A Slack message from @Rohan saying "I think Ai is fine aslong as it's Claude"](https://cdn.hackclub.com/019ff3d5-4863-7ba0-a3a4-ee457a23d882/aslong-as-its-claude.png)
...
![Screenshot of Hack Club website saying "Welcome to Hack Club / We are 111,620 teen hackers"](https://cdn.hackclub.com/019ff3d6-2eaf-7a9c-861f-628156cd4af3/wth-111k.png)
...
![Me prompting Claude, asking "How can I add a blog to my website? list some ideas"](https://cdn.hackclub.com/019ff3d6-a81f-7fb8-af36-ff2e243d308f/how-blog-website-claude.png)
...
![Section from HCTG submission guidelines detailing 30% AI limit](https://cdn.hackclub.com/019ff3d7-2655-75e9-87d3-8119259f1af7/hctg-30-percent.png)
![Message from @NotARoomba detailing a 40% AI limit](https://cdn.hackclub.com/019ff3d7-2584-7938-b2c0-377cde138e0c/notaroomba-40-percent.png)
...
The solution is to detail these exactly. What are reviewers looking for? How should we (participants) be using AI? How shouldn't we be?
...
![Prox2 anonymous message saying "We should add a VAC ban-like thingy for YSWSes"](https://cdn.hackclub.com/019ff3d5-4746-7cdf-8278-0af180ec19f6/vac-bans-anon.png)
